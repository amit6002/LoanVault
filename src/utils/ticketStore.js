...
const INITIAL_TICKETS = [
  {
    ...
    borrowerId: 1,
    borrowerName: 'Rahul Sharma (Demo Borrower)',
    borrowerEmail: 'borrower@loanvault.com',
    assignedOfficer: 'Pooja Verma (Loan Officer)',
    category: 'EMI',
    ...
    messages: [
      {
        id: 1,
        senderRole: 'BORROWER',
        senderName: 'Rahul Sharma (Demo Borrower)',
      ...
      },
      {
        id: 2,
        senderRole: 'OFFICER',
        senderName: 'Pooja Verma (Loan Officer)',
